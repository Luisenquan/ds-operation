...
# 
api_key="26d5c0dfe50efcdee631029fea153ac7199257271" 			#api_key
api_token="372fdd725d678a97f5c05f388ace48e61016680057" 	#api_token
url="http://192.168.11.202:5858/server/index.php?s=/api/open/fromComments" #同步到的url。使用www.showdoc.cc的不需要修改，使用开源版的请修改
#
#http://192.168.11.202:5858/web/#/item/index
#
#https://www.showdoc.cc/server/api/open/fromComments
#
#
